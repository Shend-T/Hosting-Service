...
function About() {
  return (
    <div className="container pt-5 pb-0 mt-5 mb-0" style={{ height: "90vh" }}>
      <section className="p-4 p-md-5 mb-5 text-center border rounded shadow-sm mt-5">
      ...
      <section className="row g-4 mt-5 mb-5">
          ...
          <div className="col-md-4">
            <div className="card shadow-sm h-100">
              <div className="card-body p-4">
                ...
                <p className="card-text mb-0">
                  Andre handles backend logic and sets up the infrastructure
